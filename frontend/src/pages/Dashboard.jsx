...
const StatCard = ({ title, value, icon, rgb, delay, onClick }) => (
  <motion.div 
    ...
    style={{
      ...
      boxShadow: '0 4px 20px var(--shadow-color-rgb)',
      display: 'flex',
      alignItems: 'center',
      gap: '20px',
...
const Dashboard = () => {
  ...
  const OwnerDashboard = () => (
    ...
    >
      ...
      <div key="chart" style={{ background: 'var(--bg-panel)', borderRadius: '24px', padding: '24px', boxShadow: '0 4px 20px var(--shadow-color-rgb)', border: '1px solid var(--border-color-rgb)' }}>
        <h3 style={{ fontSize: '18px', fontWeight: 800, color: 'var(--text-main)', marginBottom: '24px' }}>{t('companyPerformance')}</h3>
        <div style={{ height: 'calc(100% - 60px)', display: 'flex', alignItems: 'flex-end', justifyContent: 'space-around', paddingBottom: '16px' }}>
            <div style={{ width: '64px', background: '#3b82f6', borderRadius: '8px 8px 0 0', height: '80%', position: 'relative' }}>
              ...
              <div style={{ position: 'absolute', bottom: '-24px', fontSize: '12px', fontWeight: 700, color: 'var(--text-muted)', left: '50%', transform: 'translateX(-50%)', whiteSpace: 'nowrap' }}>Auto Parts</div>
            </div>
            <div style={{ width: '64px', background: '#6366f1', borderRadius: '8px 8px 0 0', height: '60%', position: 'relative' }}>
              ...
              <div style={{ position: 'absolute', bottom: '-24px', fontSize: '12px', fontWeight: 700, color: 'var(--text-muted)', left: '50%', transform: 'translateX(-50%)', whiteSpace: 'nowrap' }}>Distribution</div>
            </div>
            <div style={{ width: '64px', background: '#10b981', borderRadius: '8px 8px 0 0', height: '90%', position: 'relative' }}>
              ...
              <div style={{ position: 'absolute', bottom: '-24px', fontSize: '12px', fontWeight: 700, color: 'var(--text-muted)', left: '50%', transform: 'translateX(-50%)', whiteSpace: 'nowrap' }}>Contracting</div>
            </div>
            <div style={{ width: '64px', background: '#f59e0b', borderRadius: '8px 8px 0 0', height: '40%', position: 'relative' }}>
              ...
              <div style={{ position: 'absolute', bottom: '-24px', fontSize: '12px', fontWeight: 700, color: 'var(--text-muted)', left: '50%', transform: 'translateX(-50%)', whiteSpace: 'nowrap' }}>Labour Hire</div>
            </div>
        </div>
      </div>
      
      <div key="summary" style={{ background: 'linear-gradient(135deg, #0f172a, #312e81)', borderRadius: '24px', padding: '24px', color: 'var(--bg-panel)', boxShadow: '0 20px 40px rgba(15,23,42,0.2)', position: 'relative', overflow: 'hidden' }}>
        <SparklesBg />
  ...
  const DistributionDashboard = () => (
    ...
    >
      ...
      <div key="brands" style={{ background: 'var(--bg-panel)', borderRadius: '24px', padding: '24px', border: '1px solid var(--border-color-rgb)', boxShadow: '0 4px 20px var(--shadow-color-rgb)', display: 'flex', flexDirection: 'column', height: '100%', boxSizing: 'border-box' }}>
        <h3 style={{ fontSize: '16px', fontWeight: 800, color: 'var(--text-main)', marginBottom: '20px', margin: '0 0 20px 0' }}>Sales by Brand/Product</h3>
        <div style={{ flex: 1, minHeight: 0 }}>
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={chartData.brands} margin={{ left: -20, right: 10, bottom: 0, top: 0 }}>
              <XAxis dataKey="name" tick={{ fontSize: 11, fill: 'var(--text-muted)' }} axisLine={false} tickLine={false} />
              <YAxis tick={{ fontSize: 11, fill: 'var(--text-muted)' }} axisLine={false} tickLine={false} />
              <RechartsTooltip cursor={{ fill: 'rgba(59,130,246,0.1)' }} contentStyle={{ borderRadius: '12px', border: 'none', boxShadow: '0 4px 20px var(--shadow-strong-rgb)' }} />
      ...
      <div key="areas" style={{ background: 'var(--bg-panel)', borderRadius: '24px', padding: '24px', border: '1px solid var(--border-color-rgb)', boxShadow: '0 4px 20px var(--shadow-color-rgb)', display: 'flex', flexDirection: 'column', height: '100%', boxSizing: 'border-box' }}>
        <h3 style={{ fontSize: '16px', fontWeight: 800, color: 'var(--text-main)', marginBottom: '20px', margin: '0 0 20px 0' }}>Sales by Area (Route)</h3>
        <div style={{ flex: 1, minHeight: 0 }}>
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={chartData.areas} layout="vertical" margin={{ left: 10, right: 10, top: 0, bottom: 0 }}>
              <XAxis type="number" hide />
              <YAxis type="category" dataKey="name" tick={{ fontSize: 11, fill: 'var(--text-muted)' }} width={80} axisLine={false} tickLine={false} />
              <RechartsTooltip cursor={{ fill: 'rgba(16,185,129,0.1)' }} contentStyle={{ borderRadius: '12px', border: 'none', boxShadow: '0 4px 20px var(--shadow-strong-rgb)' }} />
      ...
      <div key="split" style={{ background: 'var(--bg-panel)', borderRadius: '24px', padding: '24px', border: '1px solid var(--border-color-rgb)', boxShadow: '0 4px 20px var(--shadow-color-rgb)', display: 'flex', flexDirection: 'column', height: '100%', boxSizing: 'border-box' }}>
        <h3 style={{ fontSize: '16px', fontWeight: 800, color: 'var(--text-main)', marginBottom: '10px', margin: '0 0 10px 0' }}>Cash vs Credit</h3>
        <div style={{ flex: 1, position: 'relative', minHeight: 0 }}>
          <ResponsiveContainer width="100%" height="100%">
            <PieChart>
              ...
              <RechartsTooltip contentStyle={{ borderRadius: '12px', border: 'none', boxShadow: '0 4px 20px var(--shadow-strong-rgb)' }} />
            </PieChart>
          </ResponsiveContainer>
          <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', pointerEvents: 'none' }}>
            <span style={{ fontSize: '12px', fontWeight: 800, color: 'var(--text-muted)' }}>TOTAL</span>
            <span style={{ fontSize: '20px', fontWeight: 900, color: 'var(--text-main)' }}>{chartData.splits.reduce((a,b)=>a+b.value, 0)}</span>
          </div>
        </div>
      </div>

      <div key="collections" style={{ background: 'var(--bg-panel)', borderRadius: '24px', padding: '24px', border: '1px solid var(--border-color-rgb)', boxShadow: '0 4px 20px var(--shadow-color-rgb)', display: 'flex', flexDirection: 'column', height: '100%', boxSizing: 'border-box' }}>
        <h3 style={{ fontSize: '16px', fontWeight: 800, color: 'var(--text-main)', marginBottom: '24px', margin: '0 0 24px 0' }}>Customer Collections</h3>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', flex: 1, justifyContent: 'center' }}>
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
              <span style={{ fontSize: '13px', fontWeight: 700, color: 'var(--text-muted)' }}>Collected</span>
          ...
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
              <span style={{ fontSize: '13px', fontWeight: 700, color: 'var(--text-muted)' }}>Outstanding</span>
      ...
      <div key="reps" style={{ background: 'var(--bg-panel)', borderRadius: '24px', padding: '24px', border: '1px solid var(--border-color-rgb)', boxShadow: '0 4px 20px var(--shadow-color-rgb)', overflowY: 'auto', display: 'flex', flexDirection: 'column', height: '100%', boxSizing: 'border-box' }}>
        <h3 style={{ fontSize: '16px', fontWeight: 800, color: 'var(--text-main)', marginBottom: '20px', margin: '0 0 20px 0' }}>{t('topSalesReps')}</h3>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', flex: 1 }}>
          {chartData.reps && chartData.reps.slice(0,5).map((rep, i) => (
            <div key={i} onClick={() => navigate('/employees')} style={{ cursor: 'pointer', display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '16px', background: 'var(--bg-main)', borderRadius: '16px', border: '1px solid #f1f5f9' }}>
  ...
  const CashierDashboard = () => (
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '24px' }}>
      <motion.div 
        ...
        style={{ background: 'linear-gradient(135deg, #2563eb, #4338ca)', borderRadius: '32px', padding: '40px', color: 'var(--bg-panel)', position: 'relative', overflow: 'hidden', boxShadow: '0 20px 40px rgba(37,99,235,0.2)' }}
      >
        <div style={{ position: 'relative', zIndex: 10 }}>
          ...
          <button 
            ...
            style={{ background: 'var(--bg-panel)', color: '#2563eb', border: 'none', padding: '16px 24px', borderRadius: '16px', fontWeight: 800, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px', boxShadow: '0 10px 25px var(--shadow-strong-rgb)' }}
      ...
      <motion.div 
        initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }}
        style={{ background: 'var(--bg-panel)', borderRadius: '32px', padding: '40px', border: '1px solid var(--border-color-rgb)', boxShadow: '0 4px 20px var(--shadow-color-rgb)', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}
      >
        <div style={{ fontSize: '12px', fontWeight: 800, color: 'var(--text-muted)', marginBottom: '16px', letterSpacing: '1px', textTransform: 'uppercase' }}>GPS Attendance Status</div>
        {activeAttendance ? (
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '8px' }}>
              <div style={{ width: '12px', height: '12px', borderRadius: '50%', background: '#10b981', boxShadow: '0 0 12px rgba(16,185,129,0.5)' }} />
              <span style={{ fontSize: '24px', fontWeight: 900, color: 'var(--text-main)' }}>On Duty</span>
            </div>
            <div style={{ fontSize: '14px', color: 'var(--text-muted)', fontWeight: 600, marginBottom: '24px' }}>
          ...
          <button 
            ...
            style={{ width: '100%', padding: '20px', borderRadius: '16px', background: 'var(--bg-main)', border: '2px dashed #cbd5e1', color: 'var(--text-main)', fontWeight: 800, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px' }}
          >
  ...
  const SparklesBg = () => (
    <div style={{ position: 'absolute', inset: 0, overflow: 'hidden', pointerEvents: 'none', opacity: 0.3 }}>
      {[...Array(10)].map((_, i) => (
        <div key={i} style={{
          position: 'absolute', width: '4px', height: '4px', background: 'var(--bg-panel)', borderRadius: '50%',
  ...
  return (
    <div style={{ padding: '100px 40px 40px 40px', minHeight: '100vh', background: 'var(--bg-main)', fontFamily: "'Outfit', sans-serif", position: 'relative', direction: isRTL ? 'rtl' : 'ltr' }}>
      <header style={{ marginBottom: '40px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', flexWrap: 'wrap', gap: '16px' }}>
        ...
        <div style={{ display: 'flex', gap: '12px' }}>
          <button onClick={() => window.location.reload()} style={{ padding: '12px 20px', borderRadius: '16px', border: '1px solid #e2e8f0', background: 'var(--bg-panel)', fontWeight: 800, display: 'flex', alignItems: 'center', gap: '8px', color: '#475569', cursor: 'pointer' }}>
